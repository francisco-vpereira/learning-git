...
# 2. Starting a repository in our local machine and upload it to our github account
  ...
  - Create a markdown file using our favorite text editor : ***vim README.md*** 
  ...
  - Afterward, in our terminal, we type the following command : ***git remote add origin < \HTTPS>***. This will connect out local git repository with our brand new github repository. 
